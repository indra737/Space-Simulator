...
function draw(){
 ...
 if(keyDown("space")){
  ...
  text("Coins Collected: "+coinsCollected,300,50);
  text("Enemys Killed: "+ enemysDefeated,80,50);
  text("Planets Destroyed: "+ planetsDestroyed,780,50);
 ...
 function coins(){
  if(frameCount%200==0){
  var coins=createSprite(1000,random(20,370),150,10)
...
function stars(){
  if(frameCount%0.5==0){
  var  stars=createSprite(2000,random(20,750),1,1);
...
function ufofunction(){
  if(frameCount%30==0){
    var ufo=createSprite(2000,random(20,750),20,20)
...
function asteroid(){
 if(frameCount%40==0){
  ...
  var meteor=createSprite(2000,random(20,750),20,20)
...
function Createbullet(){
  ...
  var bullet=createSprite(100,100,20,20)
...
function CreatePlanet(){
    if(frameCount%200==0){
  var  planetSprite=createSprite(1500,random(20,500),20,20)
  planetSprite.velocityX=-7;
...
function CreateVenus(){
  if(frameCount%305==0){
    var Venus=createSprite(1500,random(20,500),20,20)
